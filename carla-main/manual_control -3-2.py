...
channel_crash = pygame.mixer.Channel(12)
run=pygame.mixer.Sound('run_high.wav')
channel_run = pygame.mixer.Channel(13)
crash_car=pygame.mixer.Sound('car_crush.wav')
channel_crash_car = pygame.mixer.Channel(14)
near_car_horn=pygame.mixer.Sound('near_car_horn.wav')
channel_near_car_horn = pygame.mixer.Channel(15)
run_low=pygame.mixer.Sound('run_low.wav')
channel_run_low = pygame.mixer.Channel(4)
bus_stop=pygame.mixer.Sound('bus_sop.wav')
channel_bus_stop = pygame.mixer.Channel(5)
bus_ride=pygame.mixer.Sound('bus_ride.wav')
channel_bus_ride = pygame.mixer.Channel(8)
bus_idle=pygame.mixer.Sound('bus_idle.wav')
channel_bus_idle = pygame.mixer.Channel(9)
flip_reverse=pygame.mixer.Sound('flip_reverse.wav')
channel_flip_reverse = pygame.mixer.Channel(10)
start_engine=pygame.mixer.Sound('start_engine.wav')
channel_start_engine = pygame.mixer.Channel(17)
end_sound=pygame.mixer.Sound('end_sound.wav')
channel_end_sound = pygame.mixer.Channel(18)
grade__sound=pygame.mixer.Sound('grade.wav')
channel_grade = pygame.mixer.Channel(19)
flip=pygame.mixer.Sound('flip.wav')
channel_flip = pygame.mixer.Channel(16)
...
class World(object):
    def __init__(self, carla_world, hud, args):
        ...
        self.create_vespa_8()
        self.create_vespa_9()
        self.create_vespa_11()
        self.create_vespa_13()
        self.create_vespa_14()
        self.create_vespa_15()
        self.create_vespa_16()
        self.create_vespa_17()
        self.create_vespa_18()
        self.create_vespa_19()
        self.create_vespa_20()
        self.create_near_car()
        self.create_bus()
        self.create_crash_car()
        self.create_walker_2()
        self.create_vespa_reverse()
        self.restart()
        self.create_walker_1()
        self.create_dumb_car()
        self.create_high_car()
        self.create_high_car_2()
        self.create_bus_last()
        self.create_bicycle()
    ...
    def create_walker_1(self):
        walker_bp = self.world.get_blueprint_library().find('walker.pedestrian.0038')
        walker_bp.set_attribute('is_invincible', 'False')
        spawn_location_3 = carla.Location(x=-186.01, y=-4.4, z=0.2) 
        ...
        self.walker_1 = self.world.try_spawn_actor(walker_bp, custom_transform_3)
        self.modify_vehicle_physics(self.walker_1)    
        self.walker_1.set_collisions(True)
        self.walker_1.set_simulate_physics(True)
    def create_walker_2(self):
        walker_bp = self.world.get_blueprint_library().find('walker.pedestrian.0011')
        walker_bp.set_attribute('is_invincible', 'False')
        spawn_location_3 = carla.Location(x=79.41, y=24.75, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.walker_2 = self.world.try_spawn_actor(walker_bp, custom_transform_3)
        self.modify_vehicle_physics(self.walker_2)
        self.walker_2.set_collisions(True)
        self.walker_2.set_simulate_physics(True)
    def create_bicycle(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.diamondback.century')
        spawn_location_3 = carla.Location(x=-297.22, y=-10.78, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.bicycle = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.bicycle) 
    #用來抓紅綠燈
    def create_vespa_2(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=122.09, y=-12.87, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_2 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_2) 
    def create_vespa_3(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=139.54, y=34.69, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_3 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_3)   
    def create_vespa_4(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=109.69, y=25.25, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=270, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_4 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_4) 
    def create_vespa_13(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=68.25, y=25.24, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=90, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_13 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_13) 
    def create_vespa_14(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=21.15, y=25.81, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_14 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_14) 
    def create_vespa_15(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=37.12, y=-4.77, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_15 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_15) 
    def create_vespa_11(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-6.78, y=-1.70, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_11 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_11) 
    def create_vespa_8(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-144.03, y=-2.15, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_8 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_8) 
    def create_vespa_16(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-184.72, y=-49.66, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_16 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_16)
    def create_vespa_17(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-184.4, y=-16.95, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_17 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_17)
    def create_vespa_18(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-184.14, y=11.25, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_18 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_18)
    def create_vespa_19(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-223.29, y=-4.569, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_19 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_19)
    def create_vespa_20(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-215.17, y=-25.21, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_20 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_20)
    def create_vespa_9(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-264.69, y=-27.32, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_9 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_9)
    def create_vespa_1(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=77.37, y=-14.06, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_1 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_1) 
    def create_vespa_reverse(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=35.77, y=18.78, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=90, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_reverse = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)

    def create_crash_car(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.audi.tt')
        spawn_location_3 = carla.Location(x=-4.7, y=32.83, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.crash_car = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.crash_car.set_autopilot(False)
        self.crash_car.disable_constant_velocity()
        self.modify_vehicle_physics(self.crash_car) 
    def create_near_car(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.audi.tt')
        spawn_location_3 = carla.Location(x=34.8, y=-18.53, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.near_car = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.near_car.set_autopilot(False)
        self.near_car.disable_constant_velocity()
        self.modify_vehicle_physics(self.near_car)  
    def create_high_car(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.audi.tt')
        spawn_location_3 = carla.Location(x=43.07, y=1.80, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=180, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.high_car = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.high_car.set_autopilot(False)
        self.high_car.disable_constant_velocity()
        self.modify_vehicle_physics(self.high_car)
    def create_high_car_2(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.audi.tt')
        spawn_location_3 = carla.Location(x=-349, y=-19.65, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.high_car_2 = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.high_car_2.set_autopilot(False)
        self.high_car_2.disable_constant_velocity()
        self.modify_vehicle_physics(self.high_car_2)
    def create_dumb_car(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.audi.tt')
        spawn_location_3 = carla.Location(x=-161.9, y=-46.13, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-180, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.dumb_car = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.dumb_car.set_autopilot(False)
        self.dumb_car.disable_constant_velocity()
        self.modify_vehicle_physics(self.dumb_car)
    def create_bus(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.mitsubishi.fusorosa')
        spawn_location_3 = carla.Location(x=54.48, y=-14.95, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.bus = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.bus.set_autopilot(False)
        self.bus.disable_constant_velocity()
        self.modify_vehicle_physics(self.bus)  
    def create_bus_last(self):
        vehicle_bp_3 = self.world.get_blueprint_library().find('vehicle.mitsubishi.fusorosa')
        spawn_location_3 = carla.Location(x=146.25, y=-76.75, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-180, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.bus_last = self.world.try_spawn_actor(vehicle_bp_3, custom_transform_3)
        self.bus_last.set_autopilot(False)
        self.bus_last.disable_constant_velocity()
        self.modify_vehicle_physics(self.bus_last)            
    ...
    def restart(self):
        ...
        while self.player is None:
            spawn_location = carla.Location(x=40.80, y=-18.53, z=0.2) 
            spawn_rotation = carla.Rotation(pitch=0.0, yaw=0, roll=0.0)
...
def horn():
    ...
    if count_horn==1:
        ...
        pass 
vespa_part=0
def control_reverse_vespa(world):
    global vespa_part
    control_2 = carla.VehicleControl()
    location=world.vespa_reverse.get_location()
    transform = world.vespa_reverse.get_transform()
    rotation = transform.rotation
    if vespa_part==0 and location.y>=23.6:
        vespa_part+=1  
    elif vespa_part==1 and rotation.yaw<=1 and rotation.yaw>=-1:  
        vespa_part+=1  
    elif vespa_part==2 and location.x>=83:  
        vespa_part+=1  
    if vespa_part==0:
        ...
        world.vespa_reverse.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0, brake=1.0)) 
        return 1 
    if world.vespa_reverse is not None:
        world.vespa_reverse.apply_control(control_2)
    return 0
volume_states = {
    "driving": {
...
def game_loop(args):
    ...
    world = None
    writer = imageio.get_writer('output3-2.mp4', fps=50, quality=1, codec='libx264', bitrate='2000k')

    excel_path = "output_data3-2.xlsx"
    workbook = Workbook()
    ...
    #設定事件觸發點
    event_location1=carla.Location(x=79.43, y=-16.75, z=0)
    event_location2=carla.Location(x=122.28, y=-16.68, z=0)
    event_location3=carla.Location(x=138.41, y=27.91, z=0)
    event_location4=carla.Location(x=107.34, y=29.24, z=0)
    event_location5=carla.Location(x=66.73, y=29.24, z=0)
    event_location6=carla.Location(x=33.73, y=24.94, z=0)
    event_location7=carla.Location(x=19.32, y=0.785, z=0)
    event_location8=carla.Location(x=-11.78, y=1.88, z=0)
    event_location9=carla.Location(x=-139.31, y=-7.20, z=0)
    event_location10=carla.Location(x=-139.12, y=-29.73, z=0)
    event_location11=carla.Location(x=-180.7, y=-37.29, z=0)
    event_location12=carla.Location(x=-180.70, y=-14.24, z=0)
    event_location13=carla.Location(x=-187.97, y=0.1811, z=0)
    event_location14=carla.Location(x=-218.01, y=-5.28, z=0)
    event_location15=carla.Location(x=-225.9, y=-23.04, z=0)
    event_location16=carla.Location(x=-270.81, y=-23.59, z=0)
    event_location17=carla.Location(x=-291.82, y=-19.15, z=0)
    distance_16 = abs(event_location16.x - event_location17.x) + abs(event_location16.y - event_location17.y)
    distance_15 = abs(event_location15.x - event_location16.x) + abs(event_location15.y - event_location16.y) + distance_16
    distance_14 = abs(event_location14.x - event_location15.x) + abs(event_location14.y - event_location15.y) + distance_15
    distance_13 = abs(event_location13.x - event_location14.x) + abs(event_location13.y - event_location14.y) + distance_14
    distance_12 = abs(event_location12.x - event_location13.x) + abs(event_location12.y - event_location13.y) + distance_13
    distance_11 = abs(event_location11.x - event_location12.x) + abs(event_location11.y - event_location12.y) + distance_12
    distance_10 = abs(event_location10.x - event_location11.x) + abs(event_location10.y - event_location11.y) + distance_11
    distance_9  = abs(event_location9.x  - event_location10.x) + abs(event_location9.y  - event_location10.y) + distance_10
    distance_8  = abs(event_location8.x  - event_location9.x)  + abs(event_location8.y  - event_location9.y)  + distance_9
    distance_7  = abs(event_location7.x  - event_location8.x)  + abs(event_location7.y  - event_location8.y)  + distance_8
    distance_6  = abs(event_location6.x  - event_location7.x)  + abs(event_location6.y  - event_location7.y)  + distance_7
    distance_5  = abs(event_location5.x  - event_location6.x)  + abs(event_location5.y  - event_location6.y)  + distance_6
    distance_4  = abs(event_location4.x  - event_location5.x)  + abs(event_location4.y  - event_location5.y)  + distance_5
    distance_3  = abs(event_location3.x  - event_location4.x)  + abs(event_location3.y  - event_location4.y)  + distance_4
    distance_2  = abs(event_location2.x  - event_location3.x)  + abs(event_location2.y  - event_location3.y)  + distance_3
    distance_1  = abs(event_location1.x  - event_location2.x)  + abs(event_location1.y  - event_location2.y)  + distance_2
        ...
        while True:       
            ...
            if player.is_at_traffic_light() and reset_traffic_time==1:
                ...
                if traffic_light.get_state() == carla.TrafficLightState.Green:
                    ...
                    traffic_light1 = world.vespa_1.get_traffic_light()
                    traffic_light1.set_state(carla.TrafficLightState.Green)
                    traffic_light1.freeze(True)
                    traffic_light2 = world.vespa_2.get_traffic_light()
                    traffic_light2.set_state(carla.TrafficLightState.Green)
                    traffic_light3 = world.vespa_3.get_traffic_light()
                    traffic_light3.set_state(carla.TrafficLightState.Green)
                    traffic_light4 = world.vespa_4.get_traffic_light()
                    traffic_light4.set_state(carla.TrafficLightState.Green)
                    traffic_light8 = world.vespa_8.get_traffic_light()
                    traffic_light8.set_state(carla.TrafficLightState.Green)
                    traffic_light11 = world.vespa_11.get_traffic_light()
                    traffic_light11.set_state(carla.TrafficLightState.Green)
                    traffic_light13 = world.vespa_13.get_traffic_light()
                    traffic_light13.set_state(carla.TrafficLightState.Red)
                    traffic_light14 = world.vespa_14.get_traffic_light()
                    traffic_light14.set_state(carla.TrafficLightState.Green)
                    traffic_light9 = world.vespa_9.get_traffic_light()
                    traffic_light9.set_state(carla.TrafficLightState.Green)
                    traffic_light11 = world.vespa_11.get_traffic_light()
                    traffic_light11.set_state(carla.TrafficLightState.Green)
                    traffic_light15 = world.vespa_15.get_traffic_light()
                    traffic_light15.set_state(carla.TrafficLightState.Green)
                    traffic_light16 = world.vespa_16.get_traffic_light()
                    traffic_light16.set_state(carla.TrafficLightState.Red)
                    traffic_light17 = world.vespa_17.get_traffic_light()
                    traffic_light17.set_state(carla.TrafficLightState.Green)
                    traffic_light18 = world.vespa_18.get_traffic_light()
                    traffic_light18.set_state(carla.TrafficLightState.Red)
                    traffic_light19 = world.vespa_19.get_traffic_light()
                    traffic_light19.set_state(carla.TrafficLightState.Green)
                    traffic_light20 = world.vespa_20.get_traffic_light()
                    traffic_light20.set_state(carla.TrafficLightState.Red)
                    print(5)
            ...
            if image_number<=4:
                ...
                if start_stop==1:
                        ...
                        if player:
                            ...
                            if current_location_state==0:
                                ...
                                if math.sqrt(dx*dx + dy*dy)<=5:
                                    world.hud.switch_direction(2)
                                    world.hud.switch_next_direction(2)
                                    if channel_near_car_horn.get_busy():
                                        channel_near_car_horn.stop()
                                    channel_bus_idle.stop()
                                    current_location_state+=1
                                ...
                                if math.sqrt(dx*dx + dy*dy)<=5:
                                    ...
                                    current_location_state+=1 
                                    traffic_light18 = world.vespa_18.get_traffic_light()
                                    traffic_light18.set_state(carla.TrafficLightState.Green)
                                    event_slow_walker=1
                                ...
                                world.hud.flash_distance(abs(dx)+abs(dy)+distance_15)
                                if math.sqrt(dx*dx + dy*dy)<=5:
                                    world.hud.switch_direction(2)
                                    world.hud.switch_next_direction(2)
                                    if left_blinker_on!=1:
                                        wrong_blinker+=1
                                    current_location_state+=1  
                            elif current_location_state==15:
                                dx = current_location.x - event_location16.x
                                dy = current_location.y - event_location16.y  
                                world.hud.flash_distance(abs(dx)+abs(dy)+distance_16)
                                if math.sqrt(dx*dx + dy*dy)<=5:
                                    world.hud.switch_direction(2)
                                    current_location_state+=1 
                                    hud.show_next_arrow = False
                                    
                            elif current_location_state==16:
                                dx = current_location.x - event_location17.x
                                dy = current_location.y - event_location17.y  
                                ...
                                if math.sqrt(dx*dx + dy*dy)<=4 and throttle<=0.4:
                                    ...
                                    current_location_state+=1 
                                    world.high_car_2.set_location(carla.Location(x=-378.76,y=25.85,z=0.2))
                                    pass_level+=1
                    ...
                    if event_dumb==1:
                        event_dumb_time=time.time()
                        event_dumb+=1
                        lights = carla.VehicleLightState.Brake
                        world.dumb_car.set_light_state(carla.VehicleLightState(lights))
                    elif event_dumb==2:
                        if time.time()-event_dumb_time>=8:
                            traffic_light16 = world.vespa_16.get_traffic_light()
                            traffic_light16.set_state(carla.TrafficLightState.Green)
                            lights = carla.VehicleLightState.Brake
                            world.dumb_car.set_light_state(carla.VehicleLightState(lights))
                            count_horn+=1
                            event_dumb+=1
                        ...
                        control_7 = carla.VehicleControl()
                        control_7.throttle=1
                        control_7.reverse=1
                        lights = carla.VehicleLightState.Brake
                        world.dumb_car.set_light_state(carla.VehicleLightState(lights))
                        world.dumb_car.apply_control(control_7)
                        if collision=='1':
                            event_dumb+=1
                            channel_crash_car.play(crash_car)
                            dumb_time=time.time()
                    elif event_dumb==5:
                        control_7 = carla.VehicleControl()
                        control_7.throttle=1
                        ...
                        world.dumb_car.set_light_state(carla.VehicleLightState(lights))
                        world.dumb_car.apply_control(control_7)
                        if time.time()-dumb_time>=0.5:
                            event_dumb+=1
                    elif event_dumb==6:
                        control_7 = carla.VehicleControl()
                        world.dumb_car.set_light_state(carla.VehicleLightState.NONE)
                        world.dumb_car.apply_control(control_7)
                        control_7.throttle=1
                        control_7.reverse=0
                        control_7.steer=-0.05
                        world.dumb_car.apply_control(control_7) 
                    
                            
                    if event_reverse==1 and current_location.x<=70:
                        event_reverse+=1
                    elif event_reverse==2:
                        if collision=='1':
                            world.vespa_reverse.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0, brake=1.0))
                            event_reverse=0
                        if control_reverse_vespa(world)==1:
                            event_reverse=0
                            
                    if event_crash==1 and current_location.x<=95:
                        walker_location=world.walker_2.get_location()
                        if walker_location.y>=32.7:
                            event_crash+=1
                            traffic_light13 = world.vespa_13.get_traffic_light()
                            traffic_light13.set_state(carla.TrafficLightState.Green)
                            channel_crash.play(crash) 
                            channel_crash.set_volume(1,0.3)
                            channel_run.stop()
                        else:
                            control_walker = carla.WalkerControl()
                            control_walker.direction = carla.Vector3D(0, 1, 0) 
                            control_walker.speed = 1.44
                            world.walker_2.apply_control(control_walker)
                            control_crash = carla.VehicleControl()
                            control_crash.throttle=1
                            world.crash_car.apply_control(control_crash)
                            if not channel_run.get_busy():
                                channel_run.play(run) 
                                channel_run.set_volume(0.35)
                    elif event_crash==2:
                        control_crash = carla.VehicleControl()
                        control_crash.throttle=1
                        world.crash_car.apply_control(control_crash)      
                    ...
                    if event_slow_walker==1:
                        control_walker_2 = carla.WalkerControl()
                        control_walker_2.direction = carla.Vector3D(0, 1, 0) 
                        control_walker_2.speed = 0.8
                        world.walker_1.apply_control(control_walker_2)  
                        walker_location_2=world.walker_1.get_location()  
                        if not channel_run_low.get_busy():
                                channel_run_low.play(run) 
                                channel_run_low.set_volume(0.35)
                        if collision=='1':
                            event_slow_walker=0
                            channel_crash.play(crash) 
                            channel_crash.set_volume(1,0.3)
                            channel_run_low.stop() 
                        if   walker_location_2.y>=14.4:
                            control_walker_2.speed = 0.0
                            world.walker_1.apply_control(control_walker_2)
                            event_slow_walker=0
                            channel_run_low.stop() 
                            
                            
                    if event_high_car_2==1:
                        count_time=time.time()
                        event_high_car_2+=1
                    elif event_high_car_2==2:
                        if time.time()-count_time>=5.5:
                            event_high_car_2+=1
                    elif event_high_car_2==3:
                        control_6 = carla.VehicleControl()
                        control_6.throttle=1
                        world.high_car_2.apply_control(control_6)
                        if time.time()-count_time>=10:
                            traffic_light20 = world.vespa_20.get_traffic_light()
                            traffic_light20.set_state(carla.TrafficLightState.Green)
                        elif time.time()-count_time>=15:
                            control_6.throttle=0
                            control_6.brake=1
                            world.high_car_2.apply_control(control_6)
                            event_high_car_2+=1
                    ...
                    if event_high==1:
                        control_2 = carla.VehicleControl()
                        control_2.throttle=0.8
                        world.high_car.apply_control(control_2) 
                        high_location=world.high_car.get_location()    
                        if high_location.x<=-3.5:
                            control_2.steer=-0.2
                            control_2.throttle=1
                            world.high_car.apply_control(control_2)   
                            if high_location.y>=4.5:
                                event_high+=1
                    elif event_high==2:
                        control_2 = carla.VehicleControl()
                        control_2.throttle=1
                        ...
                        world.high_car.apply_control(control_2) 
                        high_location=world.high_car.get_location()
                        location_player=player.get_location()
                        transform = world.high_car.get_transform()
                        transform.rotation = carla.Rotation(pitch=0.0, yaw=180, roll=0)
                        world.high_car.set_transform(transform)
                        if location_player.x-high_location.x>=5:
                            event_high+=1 
                    elif event_high==3:
                        ...
                        transform = world.high_car.get_transform()
                        rotation = transform.rotation
                        if rotation.yaw<=-178 or rotation.yaw>=178:
                            transform.rotation = carla.Rotation(pitch=0.0, yaw=180, roll=0)
                            world.high_car.set_transform(transform)
                            event_high+=1 
                        ...
                        transform.rotation = carla.Rotation(pitch=0.0, yaw=180, roll=0)
                        world.high_car.set_transform(transform) 
                        if time.time()-destory_time>=10:
                            world.high_car.set_location(carla.Location(x=-117,y=63.32,z=-1))
                                
                    if event_bus==1:
                        control_2 = carla.VehicleControl()
                        control_2.throttle=0.6
                        world.bus.apply_control(control_2)
                        bus_location=world.bus.get_location()
                        if not channel_bus_ride.get_busy():
                            channel_bus_ride.play(bus_ride)
                            channel_bus_ride.set_volume(0.15,0.3)
                        if bus_location.x>=98:
                            world.bus.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0, brake=1))
                            channel_bus_ride.stop()
                        if not channel_bus_idle.get_busy():
                            channel_bus_idle.play(bus_idle)
                            channel_bus_idle.set_volume(0.15,0.3)
                            
                    if event_near_car==1:
                        location=player.get_location()
                        location_2=world.near_car.get_location()
                        control_2 = carla.VehicleControl() 
                        velocity = player.get_velocity()
                        if location.x>= 88:
                            traffic_light2 = world.vespa_2.get_traffic_light()
                            traffic_light2.set_state(carla.TrafficLightState.Yellow)
                            event_near_car+=1
                            channel_bus_stop.stop()
                        if location.x>= 42:
                            event_bus=1
                            channel_bus_stop.set_volume(0.05,0.1)
                            
                        world.near_car.set_location(carla.Location(x=location_2.x, y=location.y, z=location.z))
                        world.near_car.set_target_velocity(carla.Vector3D(velocity.x, 0, 0))    
                        transform2 = world.near_car.get_transform()
                        transform2.rotation = carla.Rotation(pitch=0.0, yaw=0, roll=0)
                        world.near_car.set_transform(transform2)
                    elif  event_near_car==2: 
                        control_2 = carla.VehicleControl() 
                        location=player.get_location()
                        velocity = player.get_velocity()
                        if location.x>= 101:
                            traffic_light2 = world.vespa_2.get_traffic_light()
                            traffic_light2.set_state(carla.TrafficLightState.Red)
                            wait_time_1=time.time()
                            event_near_car+=1 
                        control_2.throttle = 1   
                        control_2.brake = 0
                        world.near_car.apply_control(control_2) 
                    elif  event_near_car==3:   
                        control_2 = carla.VehicleControl()
                        location=player.get_location()
                        velocity = player.get_velocity()
                        if collision_obj=='Audi Tt':
                            channel_near_car_horn.stop()
                            event_near_car+=1 
                            channel_crash_car.play(crash_car)
                        control_2.throttle = 1   
                        control_2.brake = 0
                        world.near_car.apply_control(control_2)
                    elif event_near_car==4:
                        control_2 = carla.VehicleControl()
                        location=player.get_location()
                        if  (time.time()-wait_time_1)>=5:
                            traffic_light2 = world.vespa_2.get_traffic_light()
                            traffic_light2.set_state(carla.TrafficLightState.Green)
                    ...
                    if pass_level==0:
                        ...
                        if image_number>=5:
                             if not channel_near_car_horn.get_busy():
                                channel_near_car_horn.play(near_car_horn)
                             if not channel_bus_stop.get_busy():
                                channel_bus_stop.play(bus_stop)
                                channel_bus_stop.set_volume(0.05,0.2)
