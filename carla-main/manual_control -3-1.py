...
brake2_sound=pygame.mixer.Sound('stop.wav')
channel_brake2 = pygame.mixer.Channel(1)
...
channel_flip = pygame.mixer.Channel(18)
...
class World(object):
    ...
    def create_stop_car(self):
        ...
        spawn_location_3 = carla.Location(x=3.56, y=1.989, z=0.2) 
    ...
    def create_vespa_fast(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=62.60, y=79.28, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=90, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_fast = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_fast) 
    #用來抓紅綠燈
    ...
    def create_vespa_4(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=77.41, y=26.65, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_4 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_4) 
    def create_vespa_5(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=77.41, y=-0.94, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_5 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_5) 
    def create_vespa_6(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=22.39, y=-3.54, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_6 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_6) 
    def create_vespa_7(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-143.91, y=-2.39, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_7 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_7) 
    def create_vespa_8(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-222.98, y=-27.12, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
    ...
    def create_vespa_9(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-264.66, y=-26.90, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_9 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_9) 
    def create_vespa_10(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-6.78, y=-1.70, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.vespa_10 = self.world.try_spawn_actor(vespa_light_bp, custom_transform_3)
        self.modify_vehicle_physics(self.vespa_10) 
    def create_vespa_11(self):
        vespa_light_bp = self.world.get_blueprint_library().find('vehicle.vespa.zx125')
        spawn_location_3 = carla.Location(x=-182.61, y=-26.78, z=-1.5) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=-90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
    ...
    def create_walker_1(self):
        walker_bp = self.world.get_blueprint_library().find('walker.pedestrian.0010')
        walker_bp.set_attribute('is_invincible', 'False')
        spawn_location_3 = carla.Location(x=78.33, y=46.74, z=0.2) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=90.0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
        self.walker = self.world.try_spawn_actor(walker_bp, custom_transform_3)
        self.modify_vehicle_physics(self.walker)
        self.walker.set_collisions(True)
        self.walker.set_simulate_physics(True)    
    def create_walker_2(self):
        walker_bp = self.world.get_blueprint_library().find('walker.pedestrian.0046')
        walker_bp.set_attribute('is_invincible', 'False')
        spawn_location_3 = carla.Location(x=-212.55, y=-27.36, z=0.11) 
        spawn_rotation_3 = carla.Rotation(pitch=0.0, yaw=0, roll=0)
        custom_transform_3 = carla.Transform(spawn_location_3, spawn_rotation_3)
...
def horn():
    ...
    if count_horn==1:
        ...
        pass 
def control_fast_vespa(world):
    global vespa_part
    control_2 = carla.VehicleControl()
    location=world.vespa_fast.get_location()
    transform = world.vespa_fast.get_transform()
    rotation = transform.rotation
    if vespa_part==0 and location.y>=27:
        vespa_part+=1  
    elif vespa_part==1 and rotation.yaw<=1 and rotation.yaw>=-1:  
        vespa_part+=1  
        
    if vespa_part==0:
        control_2.throttle = 0.55
        control_2.steer = -0.1 
    elif vespa_part==1: 
        ...
        world.vespa_fast.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0, brake=1.0)) 
        return 1 
    if world.vespa_fast is not None:
        world.vespa_fast.apply_control(control_2)
    return 0

def stop_stop_car(world):
    velocity = world.vehicle3.get_velocity()
    ...
    world.vehicle3.set_light_state(carla.VehicleLightState(lights))
    if velocity.x<=-2:
       world.vehicle3.apply_control(carla.VehicleControl(throttle=0.0, steer=0.0, brake=0.9))  
    else:
       world.vehicle3.set_transform(transform)
       return 1 
    return 0
def control_stop_car(world):    
    location=world.vehicle3.get_location()
    world.vehicle3.set_light_state(carla.VehicleLightState.NONE)
    if location.x>=-200:
       world.vehicle3.apply_control(carla.VehicleControl(throttle=0.55, steer=0.0, brake=0.0))  
    else:
       return 1 
    return 0
volume_states = {
...
def game_loop(args):
    ...
    world = None
    writer = imageio.get_writer('output3-1.mp4', fps=50, quality=1, codec='libx264', bitrate='2000k')

    excel_path = "output_data3-1.xlsx"
    workbook = Workbook()
    ...
    event_location3=carla.Location(x=141.88, y=39.12, z=0)
    event_location4=carla.Location(x=105.23, y=51.06, z=0)
    event_location5=carla.Location(x=74.27, y=46, z=0)
    event_location6=carla.Location(x=74.27, y=25, z=0)
    event_location7=carla.Location(x=61.73, y=0.005, z=0)
    event_location8=carla.Location(x=15.68, y=-0.82, z=0)
    event_location9=carla.Location(x=-14.96, y=2.227, z=0)
    event_location10=carla.Location(x=-138.4, y=-9.21, z=0)
    event_location11=carla.Location(x=-150.08, y=-23.94, z=0)
    event_location12=carla.Location(x=-190.14, y=-23.35, z=0)
    event_location13=carla.Location(x=-229.77, y=-23.35, z=0)
    event_location14=carla.Location(x=-267.82, y=-23.35, z=0)
    event_location15=carla.Location(x=-291.82, y=-19.15, z=0)
    distance_14 = abs(event_location14.x - event_location15.x) + abs(event_location14.y - event_location15.y)
        ...
        while True:       
            ...
            if image_number<=4:
                ...
                if start_stop==1:
                        ...
                        if player:
                            ...
                            if current_location_state==0:
                                ...
                                if math.sqrt(dx*dx + dy*dy)<=4:
                                    ...
                                    traffic_light4.set_state(carla.TrafficLightState.Red)
                                    traffic_light5 = world.vespa_5.get_traffic_light()
                                    traffic_light5.set_state(carla.TrafficLightState.Green)
                                    traffic_light6 = world.vespa_6.get_traffic_light()
                                    traffic_light6.set_state(carla.TrafficLightState.Green)
                                    traffic_light7 = world.vespa_7.get_traffic_light()
                                    traffic_light7.set_state(carla.TrafficLightState.Green)
                                    ...
                                    traffic_light10 = world.vespa_10.get_traffic_light()
                                    traffic_light10.set_state(carla.TrafficLightState.Red)
                    ...
                    if event_walker==1: 
                        if current_location.x<=87:
                            event_walker+=1
                            world.vespa_fast.set_location(carla.Location(x=70.47, y=21.68, z=0.2))      
                    elif event_walker==2:
                        walker_loc=world.walker.get_location()
                        ...
                        if walker_loc.x>=66:
                            ...
                            if not channel_run.get_busy():
                                ...
                                channel_run.set_volume(0.5)
                        else:
                            control.direction = carla.Vector3D(1, 0, 0) 
                            control.speed = 0   
                            channel_run.stop()
                        world.walker.apply_control(control)
                        if collision_obj=='Pedestrian 0010':
                            event_walker=0
                            channel_crash.play(crash) 
                            channel_run.stop()
                            
                    if event_fast_vespa==1:
                        event_fast_vespa+=1
                        wait_a_minute=time.time()
                    elif  event_fast_vespa==2 and (time.time()-wait_a_minute)>=15:
                        traffic_light4 = world.vespa_4.get_traffic_light()
                        traffic_light4.set_state(carla.TrafficLightState.Green)
                        event_fast_vespa+=1
                    elif event_fast_vespa==3:
                        control_fast_vespa(world)
                        if collision=='1':
                            event_fast_vespa=0
                    
                    if event_walker_2==1 and current_location.x<=-190:
                        event_walker_2+=1
                    elif event_walker_2==2:
                        control_2 = carla.WalkerControl()
                        control_2.direction = carla.Vector3D(0, 1, 0) 
                        control_2.speed = 3.5
                        world.walker_2.apply_control(control_2)
                        if not channel_run_low.get_busy():
                                channel_run_low.play(run_low) 
                                channel_run_low.set_volume(0.5)
                        if collision_obj=='Pedestrian 0046':
                            event_walker_2=0
                            channel_crash.play(crash) 
                            channel_run_low.stop()
                    ...
                    if event_stopcar==1:
                        stop_time=time.time() 
                        event_stopcar+=1
                    elif event_stopcar==2 and (time.time()-stop_time)>=10:
                        event_stopcar+=2
                        stop_time=time.time() 
                        traffic_light10 = world.vespa_10.get_traffic_light()
                        traffic_light10.set_state(carla.TrafficLightState.Green)
                    elif event_stopcar==3:
                        if stop_stop_car(world)==1:
                            event_stopcar+=1 
                        if collision_obj=='Audi Tt':
                            if not channel_crash_car.get_busy():
                                channel_crash_car.play(crash_car) 
                                channel_crash_car.set_volume(0.5)
                    elif event_stopcar==4:
                        if collision_obj=='Audi Tt':
                            if not channel_crash_car.get_busy():
                                channel_crash_car.play(crash_car)
                                channel_crash_car.set_volume(0.35)
                        if control_stop_car(world)==1:
                            event_stopcar=0 
                            world.vehicle3.set_location(carla.Location(x=-49.78, y=30, z=0.2))
                        if (time.time()-stop_time)>=1:
                            velocity = world.vehicle3.get_velocity()
                            nums = [1, 2, 2 ,5]
                            if random.choice(nums)==1 and velocity.x<=-5:
                                event_stopcar-=1
                                stop_time=time.time()
                            else:
                                stop_time=time.time()
